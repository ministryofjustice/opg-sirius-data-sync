...
aws rds create-db-cluster \
    --region eu-west-2 \
    --db-cluster-identifier api-preproduction \
    --db-cluster-parameter-group-name "aurora-postgresql13-ssl" \
    --db-subnet-group-name data-persitance-subnet-preproduction-vpc \
    --deletion-protection \
    --enable-cloudwatch-logs-exports postgresql \
    --engine aurora-postgresql \
    --engine-version 13.18 \
    --global-cluster-identifier preproduction-api-global \
    --kms-key-id alias/aws/rds \
    --source-region eu-west-1 \
    --vpc-security-group-ids sg-0880534244f324eba \
    --serverless-v2-scaling-configuration MinCapacity=0,MaxCapacity=32.0
