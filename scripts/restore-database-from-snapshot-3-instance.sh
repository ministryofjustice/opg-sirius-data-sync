...
rename_db_instance "$DATABASE_CLUSTER-1" "$BACKUP_CLUSTER-1"
rename_db_instance "$DATABASE_CLUSTER-2" "$BACKUP_CLUSTER-2"
...
wait_for_db_instance_available "$BACKUP_CLUSTER-1"
wait_for_db_instance_available "$BACKUP_CLUSTER-2"
