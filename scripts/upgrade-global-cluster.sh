...
wait_for_global_cluster_available $GLOBAL_CLUSTER "eu-west-1"
...
aws rds modify-db-cluster --db-cluster-identifier $REGIONAL_CLUSTER \
    ...
    --region "eu-west-1" \
    --apply-immediately
wait_for_db_cluster_available $REGIONAL_CLUSTER "eu-west-1"
...
aws rds modify-db-cluster --db-cluster-identifier $REGIONAL_CLUSTER \
    ...
    --region "eu-west-2" \
    --apply-immediately
wait_for_db_cluster_available $REGIONAL_CLUSTER "eu-west-2"
